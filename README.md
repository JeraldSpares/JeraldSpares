...
- 🎓 Finishing my **BS in Information Technology (Major in System Development)** at PHINMA-Araullo University — **graduating 2026**
- 🤖 Just completed **600-hour Full-Stack Engineering internship** at Enderun Colleges (Dec 2025 – Mar 2026)
- 🚀 Architected a **27-agent Claude Opus marketing system** for Enderun and a **70%-faster AI loan engine** for Nissan PH
...
> Designed and deployed AI-driven systems for admissions, HR requisition, and student registration across 3 operational departments. Built backend integrations in Python and Node.js connected to Supabase and Firebase.
...
| Provider | Credential |
|---|---|
| 🔵 **Google** | Developer Program **Premium Tier Member** (2026) · Chrome DevTools Power User |
| 🟠 **Anthropic Academy** | AI Specialization — AI Fluency · Claude API · Agent Skills · **Subagents · MCP** (2026) |
| 🔴 **Oracle** | **Oracle Certified Professional** — Cloud Database Services · Analytics Cloud (2025) |
| 🟡 **AWS Academy** | Introduction to Cloud Architecting (2024) |
| 🔷 **Microsoft Learn** | **AZ-305** Azure Solutions Architect · **AZ-400** Enterprise DevOps · M365 Agents SDK (2025–2026) |
| 🟢 **TESDA** | NC II — Computer System Servicing (2024) |
